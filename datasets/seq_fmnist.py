...
class SequentialFashionMNIST(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        if self.args.validation:
            ...
            test_dataset = TorchFashionMNIST(
                base_path(), train=False, download=True, transform=transform
            )
    ...
    def get_backbone():
        return MNISTMLP(
            28 * 28,
            SequentialFashionMNIST.N_TASKS * SequentialFashionMNIST.N_CLASSES_PER_TASK,
        )
